...
var pusher = new Pusher("f89e10acde4bbba2bdd9", {
    cluster: 'eu',
    encrypted: true
});
...
var onCreateChannel = function () {
    ...
    console.log('created channel with name', channelName);
...
var addMessage = function (message, userId, self) {
    ...
    if (messageList.nextSibling) {
        messageList.parentNode.insertBefore(newMessage, messageList.nextSibling);
    } else {
        messageList.parentNode.appendChild(newMessage);
    }
